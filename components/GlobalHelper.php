...
class GlobalHelper {
    ...
    public static function isValidAdmin() {
        return \Yii::$app->user
            && (\Yii::$app->user->identity->role == \app\models\User::ROLE_ADMIN || \Yii::$app->user->identity->role == \app\models\User::SUPER_ADMIN)
    ...
    public static function isSuperAdmin() {
        return \Yii::$app->user
            && \Yii::$app->user->identity->role == \app\models\User::SUPER_ADMIN
            && \Yii::$app->user->identity->status == \app\models\User::STATUS_ACTIVE;
    }
