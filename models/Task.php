...
class Task extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['user_id', 'project_id', 'action', 'status','is_tar_gz','is_backup'], 'integer'],
            [['created_at', 'updated_at'], 'safe'],
            [['file_list','tgz_name'], 'string'],
            [['title', 'link_id', 'ex_link_id', 'commit_id','start_id', 'branch'], 'string', 'max' => 100],
        ];
    }
    ...
    public function downloadLog($file_name, $file_path) {
