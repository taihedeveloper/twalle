...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="widget-box transparent" id="recent-box" style="margin-top:15px">
            <div class="tabbable no-border">
                ...
                <ul class="nav nav-tabs" id="recent-tab">
                    ...
                    <li class="">
                        <a data-toggle="tab" class="show-ftp" href="#repo-tab">Ftp</a>
                    </li>
        ...
        <?php if (empty($_GET['projectId']) || $conf->repo_type == Project::REPO_SVN || $conf->repo_type == Project::REPO_FTP) { ?>
        ...
        <?php if (empty($_GET['projectId']) || $conf->repo_type == Project::REPO_FTP) { ?>
        <div class="port" style="<?= empty($_GET['projectId']) ? 'display:none' : '' ?>">
            <?= $form->field($conf, 'repo_port')
                ->textInput([
                    'class'          => 'col-xs-3',
                ])
                ->label(yii::t('conf', 'port'), ['class' => 'control-label bolder blue col-xs-1']) ?>
        </div>
        <div class="clearfix"></div>
          ...
          <div class="widget-box transparent">
              ...
              <div class="widget-body">
                  <div class="widget-main">
                      ...
                      <!--目标机器要排除的文件-->
                      <?= $form->field($conf, 'release_excludes')
                          ->textarea([
                              'placeholder'    => 'logs',
                              'data-placement' => 'top',
                              'data-rel'       => 'tooltip',
                              'data-title'     => yii::t('conf', 'release_excludes tip'),
                          ])
                          ->label(yii::t('conf', 'release_excludes'), ['class' => 'control-label bolder']) ?>
                      <?= $form->field($conf, 'hg_deploy')
                          ->textarea([
                              'placeholder'    => 'shell',
                              'data-placement' => 'top',
                              'data-rel'       => 'tooltip',
                              'data-title'     => yii::t('conf', 'hg_deploy tip'),
                          ])
                          ->label(yii::t('conf', 'hg_deploy tip'), ['class' => 'control-label bolder']) ?>
                  </div>
              </div>
          </div>
        </div>
