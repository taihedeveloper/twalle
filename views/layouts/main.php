...
<head>
    ...
    <!-- Requires CodeMirror -->
    <script type="text/javascript" src="<?= Url::to('@web/dist/js/Mergely/codemirror.js') ?>"></script>
    <link type="text/css" rel="stylesheet" href="<?= Url::to('@web/dist/js/Mergely/codemirror.css') ?>" />

    <!-- Requires Mergely -->
    <script type="text/javascript" src="<?= Url::to('@web/dist/js/Mergely/mergely.js') ?>"></script>
    <link type="text/css" rel="stylesheet" href="<?= Url::to('@web/dist/js/Mergely/mergely.css') ?>" />
            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="<?php if(\Yii::$app->user->identity->role==11){echo Url::to('@web/site/adminlogout');}else{echo Url::to('@web/site/logout');}  ?>">
                                <i class="icon-off"></i>
...
<div class="main-container" id="main-container">
 ...
 <?php if (\Yii::$app->user->identity->role) { ?>
                ...
                <!--用户管理-->
                <?php if (\Yii::$app->user->identity->role == app\models\User::ROLE_ADMIN || \Yii::$app->user->identity->role == app\models\User::SUPER_ADMIN) { ?>
                <li>
...
<!--用户组管理-->
<?php if (\Yii::$app->user->identity->role == app\models\User::SUPER_ADMIN) { ?>
                <li>
                    <a href="#" class="dropdown-toggle">
                        <i class="icon-group"></i>
                        <span class="menu-text"> <?= yii::t('gm', 'group manager') ?></span>

                        <b class="arrow icon-angle-down"></b>
                    </a>
                    <ul class="submenu" style="display: none;">
                        <li>
                            <a href="<?= Url::to('@web/groupmanager/list') ?>">
                                <i class="icon-double-angle-right"></i>
                                <?= yii::t('gm', 'group list') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= Url::to('@web/groupmanager/add') ?>">
                                <i class="icon-double-angle-right"></i>
                                <?= yii::t('gm', 'group add') ?>
                            </a>
                        </li>
