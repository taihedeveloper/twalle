        ...
        <div class="widget-body">
            <div class="widget-main padding-6 no-padding-left no-padding-right">
                <?php foreach ($projects as $project) { ?>
                    ...
                    <a class="btn btn-inline btn-warning" style="width:150px;margin-left: 40px;white-space: normal; margin-bottom: 10px; height: 60px;" href="<?= Url::to("@web/task/submit?projectId={$project['id']}") ?>"><?= $project['name'] ?></a>
                    <?php } ?>
                <?php } ?>
            </div>
        </div>
